...
class TestSQLInjectionDetection:
    ...
    def create_test_parquet(
        self, data_dir: Path, filename: str, data: list[dict]
    ) -> Path:
    ...
    def test_detect_sql_injection_patterns(self, temp_data_dir: Path) -> None:
        ...
        test_data = [
            ...
            {
                "vin": "1G4AP6949BX114241'; DROP TABLE users; --",
                "manufacturer": "Honda",
                "model": "Civic",
            },
            # SQL injection in manufacturer
            {
                "vin": "1G4AP6949BX114242",
                "manufacturer": "'; SELECT * FROM passwords; --",
                "model": "Accord",
            },
            # SQL injection in model
            {
                "vin": "1G4AP6949BX114243",
                "manufacturer": "Toyota",
                "model": "Camry OR 1=1",
            },
            # Multiple patterns
            {
                "vin": "1G4AP6949BX114244",
                "manufacturer": "Ford; DROP TABLE cars; --",
                "model": "F-150",
            },
            # Comment patterns
            {
                "vin": "1G4AP6949BX114245",
                "manufacturer": "Chevrolet",
                "model": "Silverado /* comment */",
            },
        ]
    ...
    def test_detect_sql_keywords(self, temp_data_dir: Path) -> None:
        ...
        test_data = [
            ...
            },
            {
                "vin": "1G4AP6949BX114242",
                "manufacturer": "Toyota",
                "model": "UPDATE users SET password='hacked'",
            },
            {
                "vin": "1G4AP6949BX114243",
                "manufacturer": "Ford",
                "model": "DELETE FROM logs",
            },
        ]
...
class TestCommonPatterns:
    ...
    def test_common_patterns_detection(self, temp_data_dir: Path) -> None:
        ...
        self.create_test_parquet(
            temp_data_dir, "common_patterns_test.parquet", test_data
        )
